...
int main() {
    ...
    string atlasConnectionString = "mongodb+srv://mahathigarapati:Mahathi@cluster0.skqqvxq.mongodb.net/";
    Database database(atlasConnectionString);

    Car car1(1,"Benz", "Fair", "Black");
    Car car2(2,"Ferrari", "Excellent", "red");
    Car car3(3,"Audi", "Average", "white");
    Car car4(4,"Swift", "Fair", "pink");
    Car car5(5,"Nissan", "Excellent", "White");


    Customer customer1("Nishanth", 1, "pass123",0, 10, 20);
    Customer customer2("Mahathi", 2, "pass789", 0, 5, 40);
    Customer customer3("Bhuvan", 3, "pass101", 3, 15, 80);
    Customer customer4("Satish", 4, "pass202", 2, 8, 55);
    Customer customer5("Vanaja", 5, "pass303", 1, 5, 65);

    Employee employee1("Rhema", 101, "empPass", 2, 20, 70);
    Employee employee2("teja", 102, "empPass123", 1, 15, 80);
    Employee employee3("koushik", 103, "empPass456", 3, 25, 90);
    Employee employee4("ravi", 104, "passabc", 3, 20, 30);
    Employee employee5("Amruta", 105, "empPass789", 0, 0, 60);
